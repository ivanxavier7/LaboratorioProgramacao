...
public class Buttons {
     ...
     *   @since       1.0
     */
    public static Button confirmCardButton(Button cardConfirmButton, GridPane grid, Label logger, Stage primaryStage, Jogador jogador, BigInteger id) {
    	cardConfirmButton.setMaxSize(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
        cardConfirmButton.setOnAction(event -> Controller.lockGrid(primaryStage ,grid, logger, jogador, id));
